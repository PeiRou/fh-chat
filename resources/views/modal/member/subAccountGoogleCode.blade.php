<div>
    <div class="google-title">绑定账号：{{ 'chat_'.$account }}</div>
    ...
    <div style="text-align: center;padding-top: 20px;">
        <button class="ui black button" onclick="changeQrCode('{{ $subAccountId }}')">更换二维码</button>
    </div>
</div>
<script>
            ...
            buttons: {
                confirm: {
                    ...
                    action: function(){
                        ...
                        $('.google-mask').fadeIn();
                        $.ajax({
                            url:'/chat/action//changeGoogleCode',
                            type:'post',
                            data:{'id':id},
                            dataType:'json',
